...
public class ButtonFlat extends Button {
    ...
    public String getText() {
        return this.f83370S2.getText().toString();
    }

    @Override // net.imedicaldoctor.imd.Views.Button
    public TextView getTextView() {
        return this.f83370S2;
    }
    ...
    protected void setAttributes(AttributeSet attributeSet) {
        ...
        if (string != null) {
            ...
            this.f83370S2 = textView;
            textView.setText(string.toUpperCase());
            this.f83370S2.setTextColor(this.f83365M2);
            this.f83370S2.setTypeface(null, 1);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            layoutParams.addRule(13, -1);
            this.f83370S2.setLayoutParams(layoutParams);
            addView(this.f83370S2);
        }
    ...
    public void setBackgroundColor(int i) {
        ...
        this.f83370S2.setTextColor(i);
    }

    @Override // net.imedicaldoctor.imd.Views.Button
    public void setText(String str) {
        this.f83370S2.setText(str.toUpperCase());
    }
}
